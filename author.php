...
$query = "select title,authorname,isbn,id,duedate,studentid from Books where authorname like '%$search%'";
$result = mysqli_query($conn,$query);
if(mysqli_num_rows($result)>0)
{
?>
<table style="border-collapse: collapse;width: 100%" border="2" align="center" cellpadding="5" cellspacing="5">
<tr>
<th> ISBN </th>
<th> Title </th>
<th> Author </th>
...
echo "<center>No books found in the library by the author name $search </center>" ;
?>
</table>
