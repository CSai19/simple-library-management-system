...
$sql="INSERT INTO Books(title,authorname,isbn) VALUES ('".$title."','".$author."','".$isbn."')";

if(mysqli_query($conn,$sql)){
echo '<div class="sai"><p class="para">Book was added successfully</p></div>';
}
else{
echo '<div class="sai"><p class="para">Error</p></div>';
}
