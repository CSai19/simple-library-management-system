...
echo '
       <div style="background-image: url(back1.jpg); background-size: 100% 100%">
		...
		<h1 style="text-align: center; position: relative; top: 0.4em; left: 0.2em; padding-top:5px; padding-bottom: 0px;">RETURN</h1>
  		<div class="form">
	   <form method="POST" action="returnaction.php">
